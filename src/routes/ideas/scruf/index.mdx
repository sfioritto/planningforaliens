...
This is a bad fit for a [Product Developer](/ideas/product-developer) because they had no involvement upstream in the process and no opportunity to talk to users or dig into data about users so they could brainstorm all the ways to tackle the problem.
