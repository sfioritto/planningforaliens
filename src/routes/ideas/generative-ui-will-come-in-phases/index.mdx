...
5. AI generated CRUD
6. Skip the code &mdash; AI generates the UI on the fly
...
[Prototyping will improve](https://tldraw.substack.com/p/make-real-the-story-so-far)
...
Gradually this will become more integrated with design systems so branding can remain consistent and will require less input from developers over time. ([Already happening](https://www.builder.io/blog/visual-copilot))
