...
### Spyglasses 🌱
  ...
  - Excuse for messing around with Qwik.js, FastAPI and integrating AI functionality into a product
### Refine 💰⚰️
  - Died: 2022
  - A drop-in component for complicated user-generated queries
  - Acquired by [ClickFunnels](https://www.clickfunnels.com/)
### Fullstack Panic Podcast ⚰️
  - Died: 2021
  - How to manage a career while dealing with the incredible rate of change in technology
  - The first season was a success!
  - Recorded a second season and one of my vendors lost _all_ of my recordings and I screwed up my backups. I was too depressed about it to keep going so I gave up on the concept.
### Angular Escape Plan 💵💀
  - Died: 2016
...
### [Charlie.js](https://github.com/sfioritto/charlie.js) 🎉 🧟‍♂️
  ...
  - JS library to let you sync changes in a website to a video
