...
- Developer velocity == Business value created over time.
  - You increase velocity by decreasing time to feedback; faster test suites, compile time, UI updates, customer feedback and KPIs
  - DevOps is overhead
...
- You only find out who someone truly is when they are exhausted, thwarted, the stakes are high and nobody is looking.
